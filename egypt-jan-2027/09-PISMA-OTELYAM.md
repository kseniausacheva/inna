# ПИСЬМА В ОТЕЛИ: ЗАПРОС ГРУППОВЫХ БЛОКОВ
## Египет, январь 2027. La Royal Event. Готово к отправке.

> **Про номера в письмах.** Мы запрашиваем **18 одноместных** номеров, хотя гостей сейчас 16.
> Блок всегда проще сократить, чем увеличить: отель держит согласованное количество,
> а лишнее снимается по условию релиза. Плюс 2 твина под нашу команду там, где она ночует.
> В Каире 22–23 января команда размещается отдельно и в блок не входит.
>
> **Про даты в Four Seasons.** Вариант не выбран, поэтому спрашиваем цену **на обе даты**,
> 29 и 30 января, одним письмом. Это нормальная практика и не вызывает вопросов.
>
> **Про цены.** Цифры из открытых источников (325 и 170 за ночь) в письмах **не называем**.
> Назвать цену первым — значит закрепить её как потолок. Пусть отель предложит свою.

---

## ПИСЬМО 1 · Giza Palace Hotel & Spa, Шейх Зайед

| | |
|---|---|
| **Кому** | Info@gizapalace.com **[П]** |
| **Телефон** | +202 4883 4222 **[П]** |
| **Отдел** | Общий адрес. В первой строке просим переадресовать в Sales / Group Reservations |
| **Тема** | Group block request — 18 rooms, 22–24 January 2027 — La Royal Event |
| **Когда** | Сейчас. Январь — высокий сезон, блоки уходят за 12–14 месяцев |
| **Зачем** | Две ночи на 18 одноместных номеров и подтверждение раннего выезда 23-го |

**Текст письма:**

> Dear Sales Team,
>
> Kindly forward this request to your Group Reservations or Sales department.
>
> La Royal Event is organising a private incentive programme in Egypt in January 2027
> and we would like to request a group block at Giza Palace Hotel & Spa.
>
> **Dates:** check-in 22 January 2027, check-out 24 January 2027 (2 nights)
> **Rooms:** 18 rooms, **single occupancy**
> **Guests:** 16–18, final number confirmed 8 weeks before arrival
>
> Please quote:
>
> 1. Room rate per night, single occupancy, including breakfast, service charge and all taxes.
> 2. Category offered and whether an upgrade for 2–3 rooms is possible.
> 3. Group terms: deposit schedule, cancellation and release conditions, and the date
>    by which the final rooming list is required.
> 4. **Early breakfast on 23 January:** our group departs the hotel at 05:15. Can you
>    provide a hot breakfast or packed boxes from 04:30, and is there a charge?
> 5. **Late return the same night:** the group returns from a private visit at the Giza
>    Plateau at approximately 03:30 on 24 January. Please confirm night reception,
>    luggage assistance and security access at that hour.
> 6. Availability of a private meeting room for a short evening briefing on 22 January.
> 7. Transfer time from the hotel to the Giza Plateau and to Cairo International Airport
>    as your concierge measures it in January.
>
> We would appreciate a written quotation valid for at least 30 days.
>
> Kind regards,
> Ksenia Usacheva
> La Royal Event

**Ответ должен содержать:** цену за ночь с налогами, категорию номера, график депозита,
дату релиза, письменное согласие на ранний завтрак и ночное возвращение.
...
## ПИСЬМО 3 · Four Seasons Cairo at Nile Plaza

| | |
|---|---|
| **Кому** | reservations.cai@fourseasons.com **[П]** |
| **Телефон** | +20 2 2791 6800 (броней), +20 2 2791 7000 (ресепшен) **[П]** |
| **Адрес** | 1089 Corniche El Nil, Garden City, Cairo 11519 |
| **Тема** | Group block, two alternative dates — 29 or 30 January 2027 — La Royal Event |
| **Когда** | Сегодня. Самая срочная из трёх броней |
| **Зачем** | Одна ночь на 20 номеров + прощальный ужин. Дата зависит от выбора варианта |

**Текст письма:**

> Dear Reservations Team,
>
> Kindly forward this to your Group Sales department if appropriate.
>
> La Royal Event is organising a private programme in Egypt in January 2027.
> The group spends its final night in Cairo before departing internationally the
> following morning, and we would like to request a block at Four Seasons Cairo
> at Nile Plaza.
>
> **The itinerary has two possible shapes and we would be grateful for a quotation
> on both dates:**
>
> - **Option A:** check-in 29 January 2027, check-out 30 January 2027
> - **Option B:** check-in 30 January 2027, check-out 31 January 2027
>
> **Rooms:** 18 rooms single occupancy + 2 twin rooms for our own staff
> **Guests:** 16–18 plus 4 staff
>
> Please quote:
>
> 1. Room rate per night, single and twin, with all taxes and service charges included,
>    for each of the two dates.
> 2. Nile-view categories and the supplement.
> 3. Group terms: deposit, cancellation, release date, rooming list deadline. Please state
>    until when both dates can be held in parallel.
> 4. **A private farewell dinner for 20 guests**, seated, set menu with a beverage package,
>    in a private room or a separated area. Please quote **per person, stating clearly
>    whether service charge and VAT are included or added**, and confirm whether
>    a minimum spend applies to the private space in addition to the per-person menu.
> 5. Whether live music can be arranged in that space, and any restrictions on volume
>    or finishing time.
> 6. Late arrival: the group lands from a domestic flight in the afternoon and would
>    appreciate rooms guaranteed for immediate check-in.
> 7. Transfer time to Cairo International Airport in the morning.
>
> A written quotation valid for at least 30 days would be appreciated.
>
> Kind regards,
...
**Ответ должен содержать:** цену номера на обе даты, цену ужина с прямым ответом
«включены ли сервис и НДС», наличие минимального счёта за зал, до какого числа
держатся обе даты параллельно.
...
> групповых броней, чтобы письмо не потерялось. Спасибо!

---

## ЧТО ОТСЛЕЖИВАТЬ

| Отель | Отправлено | Ответ | Цена получена | Блок подтверждён |
|---|---|---|---|---|
| Four Seasons Cairo | | | | |
| Giza Palace | | | | |
...
1. Дата релиза — не раньше чем за 8 недель до заезда.
2. Письменно указано, включены ли сервисный сбор и НДС.
3. Стоимость и условия отмены по каждому этапу депозита.
4. Цена зафиксирована в валюте договора, а не «по курсу на дату оплаты».

---

**Обозначения источников:** **[П]** — адрес проверен по нескольким публичным источникам.
**[О]** — адрес найден, но принадлежит не тому отделу; нужен звонок.
