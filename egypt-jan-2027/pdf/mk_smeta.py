...
qs = [
 ...
 ("Сколько кают на нынешнем борту и влезает ли двадцать гостей плюс три каюты команды?",
  "Судовой оператор", "На этом держится вся выгода добора до 20: 18 366 вместо 21 814"),
 ("Ставка фрахта на борт 22–24 каюты и на борт 35–40 кают, те же даты",
  "Два-три судовых оператора", "Вилка на 30 гостей 503–572 тыс. Сейчас это наша оценка 75–90 тыс./день"),
