...
rows = [
 ...
 ("Финальный ужин, MOOD Rooftop Cairo", 250, "на гостя",
  "=B{row}", "=0",
  "Уточняется. Площадка работает с 22:00 — нужен ранний выкуп. Только вариант A"),
...
qs = [
 ...
 ("Ужин в Four Seasons: 250 — net или ++? Минимальный счёт за приватную зону сверх меню?",
