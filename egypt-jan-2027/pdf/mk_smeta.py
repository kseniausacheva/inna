...
qs = [
 ...
 ("Сколько кают на нынешнем борту и влезает ли двадцать гостей плюс три каюты команды?",
  "Судовой оператор", "На этом держится вся выгода добора до 20: 18 348 вместо 21 846"),
 ("Ставка фрахта на борт 22–24 каюты и на борт 35–40 кают, те же даты",
  "Два-три судовых оператора", "Вилка на 30 гостей 504–573 тыс. Сейчас это наша оценка 75–90 тыс./день"),
 ("Сколько корзин шара дают на одну дату и поднимают ли их одновременно?",
  "Оператор шаров, Луксор", "На 30 гостей нужны четыре корзины, 2 500 каждая"),
