...
FOURSEASONS   = 550            # ночь 30 января: вариант B, и опция лишней ночи в варианте A.
                               # Было 570, уточнено 22.09
ABU_SIMBEL    = 470
...
def client_rows(n=GUESTS, team_n=TEAM_GROUND):
    ...
    add('Отель 29 января (A) или 30 января (B)', pa['hotel_29'] * n, pb['hotel_30'] * n, '≈',
        'A: остров Элефантина, Асуан. B: Four Seasons, 550 названо отелем')
