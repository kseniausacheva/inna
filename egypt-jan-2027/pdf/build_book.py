...
<tr><td class="t" style="width:auto">Храмы маршрута <span class="muted">· стр. 19</span></td><td>История, тексты и эзотерическая традиция каждого объекта</td></tr>
<tr><td class="t" style="width:auto">Что можно добавить <span class="muted">· стр. 25</span></td><td>Десять мест вне программы, с ценой по времени</td></tr>
</table>
