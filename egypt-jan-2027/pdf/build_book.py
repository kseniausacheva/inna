...
<tr><td class="t" style="width:auto">Вариант B, 10 дней <span class="muted">· стр. 7</span></td><td>Полная программа по дням, с 22 по 31 января</td></tr>
<tr><td class="t" style="width:auto">Питание и напитки <span class="muted">· стр. 11</span></td><td>Что входит в судовой пакет, что считается отдельно, все приёмы пищи по дням</td></tr>
<tr><td class="t" style="width:auto"><b>Стоимость</b>&nbsp;<span class="muted">· стр. 14</span></td><td>Полная смета на группу, что входит, график платежей 50/50</td></tr>
<tr><td class="t" style="width:auto">Храмы маршрута <span class="muted">· стр. 17</span></td><td>История, тексты и эзотерическая традиция каждого объекта</td></tr>
<tr><td class="t" style="width:auto">Что можно добавить <span class="muted">· стр. 23</span></td><td>Десять мест вне программы, с ценой по времени</td></tr>
</table>
