...
def _price():
    ...
    ta, tb = costs.with_fee(ca), costs.with_fee(cb)
...
<tr><td class="t" style="width:auto">Если гостей будет больше <span class="muted">· стр. 18</span></td><td>Цена на группу от 16 до 27 гостей: судно оплачено целиком, каюты можно заполнить</td></tr>
